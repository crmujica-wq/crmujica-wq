...
```text
┌──[ CRISTIAN ROJAS ]
├── Nombre completo :: Cristian Ricardo Rojas Mujica
├── Alias           :: crmujica-wq
├── Perfil          :: Desarrollador web y backend en formación
├── Especialidad    :: JavaScript, Node.js, Express y PostgreSQL
├── Modalidad       :: Remota
...
Me interesa participar en equipos donde pueda transformar necesidades reales en soluciones digitales claras, mantenibles y útiles. Busco seguir creciendo en desarrollo backend, arquitectura de aplicaciones, datos y tecnologías aplicadas a la transformación digital.

### Mi forma de trabajar

- Comprender el problema antes de construir la solución.
- Organizar el código separando responsabilidades.
- Validar los flujos importantes y registrar los errores.
...
Proyecto privado en desarrollo. Su propósito es explorar una solución digital centrada en las necesidades de madres y familias, con foco en organización de información, acceso a recursos y apoyo a la comunidad.
...
- Capacidad de documentar procesos y decisiones técnicas.
...
- Mejorar inglés técnico y comunicación profesional.
